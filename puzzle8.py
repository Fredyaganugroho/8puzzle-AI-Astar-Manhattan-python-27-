...
class EightPuzzle:
    ...
    def _get_legal_moves(self): #Returns list of tuples with which the free space may be swapped
    ...
    def solve(self, h): #Performs A* search for goal state. h(puzzle) - heuristic function, returns an integer
    ...
    def find(self, value): #returns the row, col coordinates of the specified value in the graph
    ...
    def peek(self, row, col):#returns the value at the specified row and column
        return self.adj_matrix[row][col]

    def poke(self, row, col, value):#sets the value at the specified row and column
        self.adj_matrix[row][col] = value

    def swap(self, pos_a, pos_b):#swaps values at the specified coordinates
...
#heuristic used to underestimate (aka a lower bound) on the number of moves required
...
def main():
    p = EightPuzzle()
    p.set("123456078")#set inisial state
    print p
